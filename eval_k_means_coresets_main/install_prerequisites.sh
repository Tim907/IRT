...
# Fehler weil Python-dev basiert auf Python2 veraltet
sudo apt-get install -y build-essential libblas-dev liblapack-dev libssl-dev g++ python2-dev python3-capstone autotools-dev libicu-dev libbz2-dev libboost-all-dev checkinstall libreadline-dev
...
sudo apt-get install -y libncursesw5-dev libssl-dev libsqlite3-dev tk-dev libgdbm-dev libc6-dev libbz2-dev libffi-dev zlib1g-dev wget curl llvm libncurses5-dev xz-utils tk-dev liblzma-dev libreadline-dev unixodbc-dev
